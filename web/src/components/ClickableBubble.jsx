...
const ClickableBubble = ({ event }) => {
  ...
  return (
    <Link
      to={`/events/${event.id}`}
      className="font-serif font-medium bg-zinc-100 px-2 rounded-md py-1 shadow border-2 hover:shadow hover:shadow-blue-100 w-full h-fit hover:bg-blue-100 hover:ring-blue-100 hover:ring-4"
    >
      <div className="flex h-3/4 gap-2 justify-between">
        <div className="flex px-4 w-1/3 py-1">
          <FontAwesomeIcon
          ...
          <div className="flex flex-col mt-2 ml-2">
            <h1 className="text-gray-500 text-xl font-bold">{event.name}</h1>
          </div>
        </div>
