...
const EventModal = ({
  ...
  return (
    <div className="absolute flex items-center justify-center w-screen h-screen left-0 top-0 bg-black bg-opacity-35">
      <div className="w-1/2 h-fit py-10 flex flex-col justify-center items-center rounded-md bg-zinc-100 shadow-sm shadow-slate-500">
        <h1 className="font-serif text-2xl pb-5 font-bold text-[#0b4dad]">
          {eventEdit ? "Edit Event" : "New Event"}
        </h1>
        <form className="flex flex-col text-black items-center w-2/3">
          ...
          <div className="flex w-full justify-between my-3">
            <div className="">
              <label className="font-serif text-slate-500 text-base font-semibold" htmlFor="time">
                Start time:
              </label>
              <input
          ...
          <div className="w-full flex  items-center mt-2">
            <label className="block font-serif text-lg text-[#0b4dad] font-bold" htmlFor="fam_recommend">
